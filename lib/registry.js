...
const WORKING_SCRAPERS = new Set([
  ...
  'AZ-ROC', 'BUILDZOOM', 'CHECKATRADE', 'CSLB', 'CT-HIC', 'DBPR', 'FMB', 'GAS-SAFE', 'OR-CCB', 'TDLR', 'WA-LNI', 'NJ-HIC', 'NYC-HIC', 'PA-HIC', 'RBQ', 'TRUSTMARK', 'ATLANTIC-HW', 'HOUZZ', 'BBB', 'MANTA', 'YELP', 'WHICH-TRADERS',
]);
