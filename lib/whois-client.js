...
function parseWhoisResponse(raw) {
  ...
  const PRIVACY_INDICATORS = [
    ...
    'registration private', 'private by design', 'domain protection',
    'super privacy', 'id shield', 'proxy', 'guard', 'protect',
    'statutory masking', 'gdpr masked', 'contact information redacted',
  ];
