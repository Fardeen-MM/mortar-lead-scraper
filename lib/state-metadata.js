...
const CONTRACTOR_JURISDICTIONS = {
  ...
  'NPI': 'NPI Registry (8M+ US Healthcare Providers)',
  'HEALTHGRADES': 'Healthgrades (Millions of US Doctors & Dentists)',
  'REALSELF': 'RealSelf (US, Aesthetic/Cosmetic Providers)',
  'YP-CA': 'YellowPages.ca (Canada-wide Directory)',
  'JCCP': 'JCCP UK (1K+ Aesthetic Practitioners w/ Email)',
  'HEALTHPOINT-NZ': 'Healthpoint NZ (Dental & GP Practices w/ Email)',
  'NHS-UK': 'NHS.UK (England GP & Dental, 22K Practices w/ Email)',
  // Veterinary
  'RCVS-UK': 'RCVS UK (5K+ Vet Practices w/ Email)',
  // Therapists / Counsellors
  'BACP-UK': 'BACP UK (50K+ Therapists, Website for Email)',
  'PSYCH-TODAY': 'Psychology Today (100K+ US Therapists w/ Phone)',
  // Immigration
  'CICC': 'CICC Canada (17K+ Immigration Consultants w/ Email)',
  // Renewable Energy
  'MCS': 'MCS UK (5.6K Solar/Heat Pump Installers w/ Email)',
};
