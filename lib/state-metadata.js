...
// Combined lookup
const ALL_JURISDICTIONS = { ...US_STATES, ...CA_PROVINCES, ...UK_JURISDICTIONS, ...AU_STATES, ...EU_JURISDICTIONS, ...INTL_JURISDICTIONS };
...
module.exports = { STATES, US_STATES, CA_PROVINCES, UK_JURISDICTIONS, AU_STATES, EU_JURISDICTIONS, INTL_JURISDICTIONS, ALL_JURISDICTIONS, COUNTRY_MAP, getStateName, getCountry };
